...
public class InicioPrincipalActivity extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        ...
        homeBtn.setOnClickListener(v -> startActivity(new Intent(InicioPrincipalActivity.this, InicioPrincipalActivity.class)));

        cartBtn.setOnClickListener(v -> startActivity(new Intent(InicioPrincipalActivity.this, CartActivity.class)));
    }
    ...
    private void recyclerViewCategory(){
        ...
        categoryList.add(new CategoryDomain("Promociones","promo"));
        ...
        categoryList.add(new CategoryDomain("Shaken Espresso","shakenesp"));
        categoryList.add(new CategoryDomain("Espresso","newespres"));
        categoryList.add(new CategoryDomain("Nuevas bebidas","nuevasbebida"));
        categoryList.add(new CategoryDomain("Otras bebidas","otrasbebida"));
        categoryList.add(new CategoryDomain("Otros alimentos","otrosalimentos"));
